...
class SMPLServer(torch.nn.Module):
    ...
    def __init__(self, gender='male', betas=None):
        ...
        self.verts_c = smpl_output['smpl_verts'] # [1, 6890, 3]
        self.joints_c = smpl_output['smpl_jnts'] # [1, 24, 3]
        self.tfs_c = smpl_output['smpl_tfs'] # [1, 24, 4, 4]
        self.tfs_c_inv = self.tfs_c.squeeze(0).inverse()
        # self.weights_c = smpl_output['smpl_weights'] # [1, 6890, 24]

        param_canonical_deshaped = param_canonical.detach().clone()
        param_canonical_deshaped[0,-10:] = 0
        smpl_output_deshaped = self.forward(param_canonical_deshaped, absolute=True)
        ...
        self.weights_c = smpl_output_deshaped['smpl_weights'] # [1, 6890, 24]
