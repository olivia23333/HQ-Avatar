...
def broyden(g, x_init, J_inv_init, max_steps=50, cvg_thresh=1e-5, dvg_thresh=1, eps=1e-6, spatial_feat=False):
    ...
    gx[ids_val] = g(x, mask=ids_val, spatial_feat=spatial_feat)
    x_opt = x
    ...
    for _ in range(max_steps):
        ...
        delta_gx[ids_val] = g(x, mask=ids_val, spatial_feat=spatial_feat) - gx[ids_val]
